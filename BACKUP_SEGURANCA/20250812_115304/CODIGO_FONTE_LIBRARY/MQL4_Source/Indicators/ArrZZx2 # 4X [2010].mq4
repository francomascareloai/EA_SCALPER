...
#property indicator_color5  Lime//C'0,0,190'
#property indicator_width5 5
#property indicator_color6  Yellow//C'180,60,110'
#property indicator_width6 5
#property indicator_color7  Lime//C'0,0,190'
#property indicator_width7 5
#property indicator_color8  Yellow//C'180,60,110'
#property indicator_width8 5
//--------------------------------------------------------------------
int    SR     =3;
extern int    SRZZ   =60;//36;//18;
int    MainRZZ=20;
int    FP     =21;
int    SMF    =3;
bool   DrawZZ =false;
...
SetIndexBuffer(4,Up); SetIndexStyle(4,DRAW_ARROW,EMPTY);//Green up arrow
SetIndexArrow(4,167); SetIndexEmptyValue(4,0.0);
SetIndexBuffer(5,Dn); SetIndexStyle(5,DRAW_ARROW,EMPTY);//Red down arrow
SetIndexArrow(5,167); SetIndexEmptyValue(5,0.0);
SetIndexBuffer(6,pUp); SetIndexStyle(6,DRAW_ARROW,EMPTY);//Green up markers
SetIndexArrow(6,167); SetIndexEmptyValue(6,0.0);
SetIndexBuffer(7,pDn); SetIndexStyle(7,DRAW_ARROW,EMPTY);//Red down markers
SetIndexArrow(7,167); SetIndexEmptyValue(7,0.0); return(0); }//167
//---------------------------------------------------------------------
int start() { int counted_bars=IndicatorCounted(); int limit,i;
