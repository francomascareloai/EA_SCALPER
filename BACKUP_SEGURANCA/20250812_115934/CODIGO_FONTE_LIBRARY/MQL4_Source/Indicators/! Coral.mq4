...
//===============================
extern string ������ = "������"; 
extern int    ������ = 60; // (260)  (30)   gi_80
extern int    ������������ = 60;
extern bool  ShowLevels = true;
//---------------------
extern string ����              = "����";
extern color  ����_�����_������ = clrGold; // (White)
extern color  ����_�����_Buy    = clrForestGreen; // (RoyalBlue)    DarkBlue
extern color  ����_�����_Sell   = clrRed; // (DarkOrange)   Crimson   FireBrick
//---------------------
extern string ������               = "������";
extern int	  �������_����� = 3; // (2)
//===============================
...
int init() {
   ...
   SetIndexBuffer(0, g_ibuf_92);   SetIndexStyle(0, DRAW_LINE, EMPTY, �������_�����, ����_�����_������);
   SetIndexBuffer(1, g_ibuf_96);   SetIndexStyle(1, DRAW_LINE, EMPTY, �������_�����, ����_�����_Buy);
   SetIndexBuffer(2, g_ibuf_100);  SetIndexStyle(2, DRAW_LINE, EMPTY, �������_�����, ����_�����_Sell);
   if(ShowLevels)  {
...
int start() {
   ...
   for (int li_24 = li_16; li_24 >= 0; li_24--) {
      ...
      UpLine[li_24] = g_ibuf_104[li_24]+������������*_Point;
      DnLine[li_24] = g_ibuf_104[li_24]-������������*_Point;
