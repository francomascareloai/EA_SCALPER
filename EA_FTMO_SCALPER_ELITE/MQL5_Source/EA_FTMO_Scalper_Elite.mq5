...
{
   if(!order_block_detector.IsInitialized()) return 0.0;
   ...
   if(position_info.PositionType() == POSITION_TYPE_BUY)
   {
      ...
      if(Use_OrderBlock_Levels && order_block_detector.GetNearestOrderBlock(ob_level, ORDER_BLOCK_BULLISH))
      {
   ...
   else
   {
      ...
      if(Use_OrderBlock_Levels && order_block_detector.GetNearestOrderBlock(ob_level, ORDER_BLOCK_BEARISH))
      {
         return ob_level + (Structure_Buffer_Points * symbol_info.Point());
      }
   }
...
{
   if(!market_structure_analyzer.IsInitialized()) return 0.0;
   ...
   if(position_info.PositionType() == POSITION_TYPE_BUY)
   {
      ...
      if(market_structure_analyzer.GetLastStructureBreak(structure_level, STRUCTURE_BOS_BULLISH))
      {
   ...
   else
   {
      ...
      if(market_structure_analyzer.GetLastStructureBreak(structure_level, STRUCTURE_BOS_BEARISH))
      {
         return structure_level + (Structure_Buffer_Points * symbol_info.Point());
      }
   }
...
{
   if(!fvg_detector.IsInitialized()) return 0.0;
   ...
   if(position_info.PositionType() == POSITION_TYPE_BUY)
   {
      ...
      if(Use_FVG_Levels && fvg_detector.GetNearestFVG(fvg_level, FVG_BULLISH))
      {
   ...
   else
   {
      ...
      if(Use_FVG_Levels && fvg_detector.GetNearestFVG(fvg_level, FVG_BEARISH))
      {
         return fvg_level + (Structure_Buffer_Points * symbol_info.Point());
      }
   }
...
{
   if(!liquidity_detector.IsInitialized()) return 0.0;
   ...
   if(position_info.PositionType() == POSITION_TYPE_BUY)
   {
      ...
      if(Use_Liquidity_Levels && liquidity_detector.GetNearestLiquidityZone(liquidity_level, LIQUIDITY_TYPE_BUY))
      {
   ...
   else
   {
      ...
      if(Use_Liquidity_Levels && liquidity_detector.GetNearestLiquidityZone(liquidity_level, LIQUIDITY_TYPE_SELL))
      {
         return liquidity_level + (Structure_Buffer_Points * symbol_info.Point());
      }
   }
