...
public:
    ...
    void                SetLevel(ENUM_LOG_LEVEL level) { m_log_level = level; } // Definir nível de log
...
SLogEntry[] CLogger::GetLogEntries(ENUM_LOG_LEVEL min_level, int max_entries)
{
    SLogEntry result[];
