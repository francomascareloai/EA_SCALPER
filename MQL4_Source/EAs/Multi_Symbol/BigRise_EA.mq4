...
//|========================= Параметры ==============================|                                                    
//+------------------------------------------------------------------+   
extern string    Language         ="English";  
extern double    StopLoss         =1;   
extern double    ManualLot        =0.01;  
extern double    Risk             =0.01;  
extern double    ProfitPips       =10;  
extern int       TimeFrame        =1;  
extern double    EURUSD_Step      =22;
extern double    GBPUSD_Step      =22;
extern double    AUDUSD_Step      =22;
extern double    NZDUSD_Step      =22;
extern double    USDJPY_Step      =22;
extern double    USDCAD_Step      =22;
extern double    USDCHF_Step      =22;
extern double    EURJPY_Step      =22;
extern double    GBPJPY_Step      =22;
...
//|====================== Доп. Переменные ===========================|
//+------------------------------------------------------------------+
string           Commemt          ="BigRise EA by www.mforex.pro";
int              D,o;
double           Lot              =0;
