...
class HolidayInfo:
    ...
    @property
    def type(self) -> HolidayType:
        return self.holiday_type

    @type.setter
    def type(self, val: HolidayType) -> None:
...
class HolidayDetector:
    ...
    def __init__(
        self,
        preload_years: list[int] | None = None,
    ...
    def _load_us_holidays(self, year: int) -> None:
    ...
    def _load_uk_holidays(self, year: int) -> None:
    ...
    def print_holidays(self, year: int | None = None) -> None:
