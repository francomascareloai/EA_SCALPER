...
MIN_VALID_SCORE = 60  # Below this = no trade
...
# Tick value: $1.00 per tick (0.01 price move) per standard lot (100 oz)
# Formula: 100 oz * $0.01 = $1.00. For 0.01 lots, tick value = $0.01
XAUUSD_TICK_VALUE = 1.0  # Tick value in USD per standard lot
