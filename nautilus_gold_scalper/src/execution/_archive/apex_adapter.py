...
class ApexAdapter:
    ...
    def __init__(self, config: ApexAdapterConfig | None = None):
        self.config = config or ApexAdapterConfig()

        self._connection_state = ConnectionState.DISCONNECTED
        self._account: ApexAccount | None = None
        ...
        self._on_position_update: Callable | None = None
        self._on_account_update: Callable | None = None
    ...
    def get_account(self) -> ApexAccount | None:
    ...
    async def submit_bracket_order(
        ...
        side: SignalType,
        quantity: float,
        entry_price: float | None,  # None for market entry
        stop_loss: float,
        take_profit: float,
    ) -> dict[str, str | None]:
        """
    ...
    def get_order(self, order_id: str) -> ApexOrder | None:
        """Get order by ID."""
        return self._orders.get(order_id)

    def get_open_orders(self, symbol: str | None = None) -> list[ApexOrder]:
        """Get all open orders."""
        orders = []
    ...
    def get_position(self, symbol: str) -> ApexPosition | None:
