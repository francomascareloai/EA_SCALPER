...
from nautilus_trader.model.enums import AccountType, OrderSide, OrderStatus, TradingState
...
def test_trading_state_halted_denies_order_before_execution_engine() -> None:
    """TradingState.HALTED should deny order submits at RiskEngine."""
