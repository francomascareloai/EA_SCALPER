...
pub struct MacAxController {
    ...
    app_cache: std::sync::Mutex<std::collections::HashMap<String, AXUIElement>>,
}

/// Stub controller for non-macOS platforms.
...
impl MacAxController {
    pub fn new() -> Result<Self> {
        #[cfg(target_os = "macos")]
        {
            ...
            Ok(Self {
                app_cache: std::sync::Mutex::new(std::collections::HashMap::new()),
            })
        }
